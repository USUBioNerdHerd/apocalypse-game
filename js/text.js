var data = [
    {name:"Opening", title:"Welcome to Cache Valley!",
     ...
     "pop_sci":{ref:null,reftext:"---"},
     literature:{ref:null,reftext:"---"},
     choice:[
	 {short:"Button 1",change:[50,50,50,50]},
	 {short:"Button 2",change:[50,50,50,50]},
	...
	pop_sci:{ref:"https://www.nationalgeographic.com/environment/energy/reference/nuclear-energy/",reftext:"National Geographic explains Energy"},
	literature:{ref:null,reftext:"---"},
     	choice: [
	...
	"pop_sci":{ref:null,reftext:"---"},
	literature:{ref:"https://science.sciencemag.org/content/333/6047/1289/tab-pdf",reftext:"Science: Land Sharing vs Land Sparing"},
	choice: [
	...
	"pop_sci":{ref:"https://theoutline.com/post/2450/instagram-is-loving-nature-to-death?zd=1&zi=z76muwwf",reftext:"Instagram and the Environment"},
	literature:{ref:"https://doi.org/10.1016/j.biocon.2016.10.009",reftext:"Threats that affect rare plants"},
	choice: [
	...
	"pop_sci":{ref:"https://www.nature.com/articles/d41586-019-01026-8",reftext:"Effects of restoring natural forests"},
	literature:{ref:"https://esajournals.onlinelibrary.wiley.com/doi/pdf/10.1002/ecs2.2105",reftext:"Homogenization of plant diversity, composition, and structure in North American urban yards"},
	choice: [
	    {short:"Plant a community urban forest", change:[5, 5, 0, 0]},
	    {short:"Encourage locals to grow more trees", change:[10, 0, 0, 0]},
    	    {text:"You can either Plant a community urban forest or encourage locals to grow more trees."}
	]
    },
    {
	...
	choice: [
	    ...
	    {text:"You can either cycle your crops or use a distributed agricultural system."}
	]
    },
    {
	...
	"pop_sci":{ref:null,reftext:"---"},
	literature:{ref:"https://onlinelibrary.wiley.com/doi/full/10.1002/ece3.2316",reftext:"Land Usage and the white-tailed deer"},
	choice: [
	    {short:"Overhaul of public transportation", change:[10, 5, 5, 5]},
	    {short:"Outreach to locals", change:[5, 2, 2, 2]},
	    {text:"You can either invest in public transportation or increase outreach to locals, encouraging them to change their lifestyles to be more emission friendly."}
	]
    },
    {
	...
	title: "Toxic",
	summary: "High levels of nutrients and hot days are combining to cause algal blooms in Lazybottom Lake. People have been warned about the toxins, but no one warned their dogs! Dogs have been dying as a result of swimming in the lake. The water quality experts say that the algal bloom in Lake Lazybottom is another casualty of Nitrogen and Phosphorous pollution in the water. They tell you that this pollution mainly comes from local agrigculture. Some experts are suggesting that programs be started to aide local farmers in adjusting their practices to reduce the amount of fertilizer that runs off into local lakes and streams. Others argue that wetland habitat should be expanded because it will clean the water. A few experts are arguing that it is worthwhile to install a filtration plant to clean the water.",
	"pop_sci":{ref:"https://www.deseretnews.com/article/865580228/Utah-facing-costly-water-pollution-problem.html",reftext:"Water pollution in the Great Salt Lake"},
	literature:{ref:null,reftext:"---"},
	choice: [
